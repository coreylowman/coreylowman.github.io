---
title: "ND array shapes with both const generic and run time dimensions"
---
...
Most ndarray/tensor crates have shapes known either at runtime or compile time. This blog post investigates how to mix the two approaches (spoiler: we can!).
...
It's pretty simple, but very powerful. I've used this a handeful of times in dfdx, let me know if you find other uses!
...
And now we just need something to represent runtime dimensions:
...
Finally, thank you to [@skinner](https://github.com/skinner), [@iExalt](https://github.com/iExalt), and the rest of my [generous sponsors](https://github.com/sponsors/coreylowman/). I'd also like to thank all the people who are following along on the dfdx discord. Your continued support is very much appreciated and helps motivate me!
